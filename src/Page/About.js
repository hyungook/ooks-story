...
import { Wrap, Cursor, Cursor2, AboutWrap, MainHeader, About__header, Section, SectionWrap, 
        SectionHeader, SectionUl } from './About__styled';
        ...
        return <Wrap>
            ...
            <AboutWrap>
                ...
                <Section className={"section__1"}>
                    <SectionWrap className={"section__wrap"}>
                        <SectionHeader className={"section__header section__1__header"}>
                            <strong>Front-End</strong>
                        </SectionHeader>
                        <SectionUl className={"section__ul section__1__body"}>
                ...
                <Section className={"section__2"}>
                    <SectionWrap className={"section__wrap"}>
                        <SectionHeader className={"section__header section__2__header"}>
                ...
                <Section className={"section__3"}>
                    <SectionWrap className={"section__wrap"}>
                        <SectionHeader className={"section__header section__3__header"}>
                            <strong>Back-End</strong>
                        </SectionHeader>
                        <SectionUl className={"section__ul section__3__body"}>
                ...
                <Section className={"section__4"}>
                    <SectionWrap className={"section__wrap"}>
                        <SectionHeader className={"section__header section__4__header"}>
                            <strong>Dssign</strong>
                        </SectionHeader>
                        <SectionUl className={"section__ul section__4__body"}>
